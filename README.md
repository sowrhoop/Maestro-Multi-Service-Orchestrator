...
- Network access defaults to **allow**, so helper commands can reach external resources out of the box. Set `MAESTRO_SANDBOX_NET_POLICY=deny` to force an offline sandbox and only permit loopback traffic.
